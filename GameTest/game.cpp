...
{
	this->player = Player(Vector3(0.0f, 0.0f, 100.0f));
...
void Game::HandleInput()
{
	...
	{
		this->renderMode = Renderer::renderModes::Collision;
	}
...
{
	colHandler.checkPlayerBlockCollisions(player, map.blocks);
	//system("cls"); 
...
void Game::Render()
{
	...
	if (this->renderMode == Renderer::renderModes::Collision)
	{
		glBegin(GL_LINES);
